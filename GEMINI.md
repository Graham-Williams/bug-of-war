...
1.  **The One Hive Rule:** The most important rule. The pieces in play must ALWAYS form a single, contiguous cluster. A piece cannot move if its movement would temporarily or permanently split the hive into two or more groups.
